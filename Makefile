...
nginx:
	...
	docker export haconiwa-nginx > ./provision/dist/nginx.image.tar.gz
...
ssh:
	...
	docker export haconiwa-ssh > ./provision/dist/ssh.image.tar.gz
...
postfix:
	...
	docker export haconiwa-postfix > ./provision/dist/postfix.image.tar.gz
